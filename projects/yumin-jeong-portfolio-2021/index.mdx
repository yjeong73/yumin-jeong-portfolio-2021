...
The purpose for this website was to gain more experience with front-end development and showcase my abilities. This website is currently optimized for PC web browsers, and it is not quite workable with the mobile and tablet version. I am aiming to make minor updates and optimize for both versions too in the near future.
